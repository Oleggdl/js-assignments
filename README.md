[![Build Status](https://travis-ci.org/Oleggdl/js-assignments.svg?branch=master)](https://travis-ci.org/Oleggdl/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/Oleggdl/js-assignments.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/Oleggdl/js-assignments.svg)](https://github.com/Oleggdl/js-assignments/releases/latest)
...
* Edit local README.md file and update all links (just replace all occurrences of `'Oleggdl'` with your account name).
...
```
* Open https://github.com/Oleggdl/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/Oleggdl/js-assignments/builds).
